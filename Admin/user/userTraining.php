...
?> </h1>
        ...
        <tr class="row4" style="padding-right: 200px;">
            <td width="20%" height="50%" style="padding-bottom: 5px;">
                ...
                </div><div>           <pre style="color:white">
<h2>Training available</h2>
<p>The is no traings avalible right now, but we provide differents 
kinds of them where people can learn different skills that can 
help them in outside life but mostly related to photography and 
graphic design.
</p>
        </pre></div>
    </td>
