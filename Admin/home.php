...
<body>
    <table border="0">
        ...
        <tr class=" row2 ">
            <th colspan="3">
                <h1 align="center" style="font-size: 100px;">Welcome admin </h1>
            </th>
        </tr>
            ...
            <td width="20%" height="50%" style="padding-bottom: 5px;">
                <div class="loginForm" style="float:left;">
                    ...
                    <div class="reg" style="padding-bottom: 0px; margin-right:0px; margin-left:0px;">
                        ...
                        <pre>
                        <a href="users.php"><button style="font-size: 24px;">users</button></a>
                        <a href="poses.php"><button style="font-size: 24px;">poses</button></a>
                        <a href="message.php"><button style="font-size: 24px;">messages</button></a>
                            </pre>
                    </div>
                </div>  
    </td>
