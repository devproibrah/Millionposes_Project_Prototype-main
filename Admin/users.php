...
<body>
    <table border="0">
                ...
                <header>
                    ...
                    <div style="float: left;">
                        <p style="background-color: blue; margin-left: 20px; ">
                            <a href="home.php"><button style="font-size: 24px;">BACK</button></p>
                    </div>
        ...
        <tr class=" row2 ">
            <th colspan="3">
                <h1 align="center" style="font-size: 100px;">All about users </h1>
            </th>
        </tr>
            ...
            <td width="20%" height="50%" style="padding-bottom: 5px;">
                <div class="loginForm" style="float:left;">
                    ...
                    <div class="reg" style="padding-bottom: 0px; margin-right:0px; margin-left:0px;">
                        ...
                        <pre>
                        <a href="regesteredusers.php"><button style="font-size: 24px;">View regestered users </button></a>
                        <a href=""><button style="font-size: 24px;">Users session</button></a>
